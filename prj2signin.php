...
<div class="signup-form">
    <form action="prj2signin.php" method="GET">
		<h2>Sign In</h2>
...
$conn= new mysqli('localhost','root','','prj2') or die("connection failed: ".mysqli_connect_error());
 ...
 if(isset($_GET['submit'])) {
  $email_login=mysqli_real_escape_string($conn,$_GET['email']);
  $password_login=mysqli_real_escape_string($conn,md5($_GET['password']));
